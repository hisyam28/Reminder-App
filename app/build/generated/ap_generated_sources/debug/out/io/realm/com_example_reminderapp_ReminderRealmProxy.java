...
public class com_example_reminderapp_ReminderRealmProxy extends com.example.reminderapp.Reminder
    implements RealmObjectProxy, com_example_reminderapp_ReminderRealmProxyInterface {
    ...
    private ProxyState<com.example.reminderapp.Reminder> proxyState;

    com_example_reminderapp_ReminderRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.reminderapp.Reminder>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.reminderapp.Reminder createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.example.reminderapp.Reminder obj = null;
        if (update) {
            Table table = realm.getTable(com.example.reminderapp.Reminder.class);
            ReminderColumnInfo columnInfo = (ReminderColumnInfo) realm.getSchema().getColumnInfo(com.example.reminderapp.Reminder.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.example.reminderapp.Reminder.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_example_reminderapp_ReminderRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_example_reminderapp_ReminderRealmProxy) realm.createObjectInternal(com.example.reminderapp.Reminder.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_example_reminderapp_ReminderRealmProxy) realm.createObjectInternal(com.example.reminderapp.Reminder.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        final com_example_reminderapp_ReminderRealmProxyInterface objProxy = (com_example_reminderapp_ReminderRealmProxyInterface) obj;
    ...
    public static com.example.reminderapp.Reminder createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.example.reminderapp.Reminder obj = new com.example.reminderapp.Reminder();
        final com_example_reminderapp_ReminderRealmProxyInterface objProxy = (com_example_reminderapp_ReminderRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_example_reminderapp_ReminderRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.example.reminderapp.Reminder.class), false, Collections.<String>emptyList());
        io.realm.com_example_reminderapp_ReminderRealmProxy obj = new io.realm.com_example_reminderapp_ReminderRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.example.reminderapp.Reminder copyOrUpdate(Realm realm, ReminderColumnInfo columnInfo, com.example.reminderapp.Reminder object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.reminderapp.Reminder) cachedRealmObject;
        }

        com.example.reminderapp.Reminder realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.example.reminderapp.Reminder.class);
            long pkColumnIndex = columnInfo.idIndex;
            long rowIndex = table.findFirstLong(pkColumnIndex, ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$id());
            if (rowIndex == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_example_reminderapp_ReminderRealmProxy();
    ...
    public static com.example.reminderapp.Reminder copy(Realm realm, ReminderColumnInfo columnInfo, com.example.reminderapp.Reminder newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.example.reminderapp.Reminder) cachedRealmObject;
        }

        com_example_reminderapp_ReminderRealmProxyInterface realmObjectSource = (com_example_reminderapp_ReminderRealmProxyInterface) newObject;
        ...
        io.realm.com_example_reminderapp_ReminderRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.example.reminderapp.Reminder object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnIndex = columnInfo.idIndex;
        long rowIndex = Table.NO_MATCH;
        Object primaryKeyValue = ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$id();
        if (primaryKeyValue != null) {
            rowIndex = Table.nativeFindFirstInt(tableNativePtr, pkColumnIndex, ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$id());
        }
        if (rowIndex == Table.NO_MATCH) {
            rowIndex = OsObject.createRowWithPrimaryKey(table, pkColumnIndex, ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$id());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, rowIndex);
        String realmGet$namaReminder = ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$namaReminder();
        ...
        String realmGet$tanggal = ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$tanggal();
        if (realmGet$tanggal != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.tanggalIndex, rowIndex, realmGet$tanggal, false);
        }
        String realmGet$waktu = ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$waktu();
        if (realmGet$waktu != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.waktuIndex, rowIndex, realmGet$waktu, false);
        }
        String realmGet$catatan = ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$catatan();
        if (realmGet$catatan != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.catatanIndex, rowIndex, realmGet$catatan, false);
        }
        String realmGet$frekuensiData = ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$frekuensiData();
        ...
        String realmGet$prioritas = ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$prioritas();
        ...
        String realmGet$tag = ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$tag();
        if (realmGet$tag != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.tagIndex, rowIndex, realmGet$tag, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.reminderActiveIndex, rowIndex, ((com_example_reminderapp_ReminderRealmProxyInterface) object).realmGet$reminderActive(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ReminderColumnInfo columnInfo = (ReminderColumnInfo) realm.getSchema().getColumnInfo(com.example.reminderapp.Reminder.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.example.reminderapp.Reminder object = null;
        while (objects.hasNext()) {
            object = (com.example.reminderapp.Reminder) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.reminderapp.Reminder object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.reminderapp.Reminder.class);
    ...
    public static com.example.reminderapp.Reminder createDetachedCopy(com.example.reminderapp.Reminder realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.reminderapp.Reminder unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.reminderapp.Reminder();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.reminderapp.Reminder) cachedObject.object;
            }
            unmanagedObject = (com.example.reminderapp.Reminder) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_reminderapp_ReminderRealmProxyInterface unmanagedCopy = (com_example_reminderapp_ReminderRealmProxyInterface) unmanagedObject;
        com_example_reminderapp_ReminderRealmProxyInterface realmSource = (com_example_reminderapp_ReminderRealmProxyInterface) realmObject;
    ...
    static com.example.reminderapp.Reminder update(Realm realm, ReminderColumnInfo columnInfo, com.example.reminderapp.Reminder realmObject, com.example.reminderapp.Reminder newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_example_reminderapp_ReminderRealmProxyInterface realmObjectTarget = (com_example_reminderapp_ReminderRealmProxyInterface) realmObject;
        com_example_reminderapp_ReminderRealmProxyInterface realmObjectSource = (com_example_reminderapp_ReminderRealmProxyInterface) newObject;
        Table table = realm.getTable(com.example.reminderapp.Reminder.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addInteger(columnInfo.idIndex, realmObjectSource.realmGet$id());
    ...
    public boolean equals(Object o) {
        ...
        com_example_reminderapp_ReminderRealmProxy aReminder = (com_example_reminderapp_ReminderRealmProxy)o;
